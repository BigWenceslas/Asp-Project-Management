...
[assembly: OwinStartup(typeof(AITECRM.Startup))]
namespace AITECRM
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            BackTaskController obj = new BackTaskController();
            BackupController back = new BackupController();
            RecurringJob.AddOrUpdate(() => obj.SendEmail(), Cron.Daily);
            RecurringJob.AddOrUpdate(() => back.ExporterBDAuto(), Cron.Daily);
